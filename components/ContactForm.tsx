...
const ContactForm = () => {
  ...
  return (
    <section className="w-full py-[7rem] px-10 flex justify-between items-stretch gap-5">
      ...
      <div className="w-full h-full flex flex-col justify-center items-between gap-1">
        ...
        <Link
          className="w-full mb-3 border-2 border-[var(--theme-color)] flex justify-start items-center p-4 gap-7 "
          href={"/"}
        >
        ...
        >
          ...
          <div className="flex justify-between items-start flex-col">
            ...
            <p>Bole Japan, Addis Ababa, Ethiopia</p>
